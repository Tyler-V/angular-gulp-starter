...
// Bundle third party plugins.js
gulp.task('bundle:plugins', function () {
    return gulp.src('resources/js/**.js')
        .pipe(concatJs(time + '.plugins.min.js'))
        .pipe(gulp.dest('build'));
});

// Bundle vendor.js
gulp.task('bundle:vendor', function () {
    return builder.buildStatic('app/vendor.js', 'build/' + time + '.vendor.min.js')
...
gulp.task('bundle', function (callback) {
    run('bundle:plugins', 'bundle:vendor', 'bundle:main', function () {
        callback();
    });
});
...
gulp.task('replace', function () {
    gulp.src('index.html')
        .pipe(htmlreplace({
            ...
            'plugins': time + '.plugins.min.js',
            'vendor': time + '.vendor.min.js',
